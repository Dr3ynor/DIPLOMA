...
from tsp_solver.routing.openrouteservice_routing import DEFAULT_ORS_PROFILE_KEY, sanitize_avoid_features
...
class AppState(Subject):
    def __init__(self):
        ...
        from tsp_solver.state.app_settings import load_ors_hgv_restrictions
    ...
    def set_ors_routing_profile(self, key: str, *, persist: bool = True) -> None:
        from tsp_solver.state.app_settings import normalize_ors_routing_profile, save_ors_routing_profile
    ...
    def set_ors_hgv_restrictions(
        ...
        *,
        ...
        from tsp_solver.state.app_settings import normalize_ors_hgv_restrictions, save_ors_hgv_restrictions
    ...
    def get_ors_profile_params_for_ors(self) -> dict | None:
        ...
        if self._ors_routing_profile != "hgv":
            return None
        from tsp_solver.state.app_settings import normalize_ors_hgv_restrictions
