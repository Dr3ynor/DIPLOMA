...
\section{Vizualizace}
Vizualizační vrstva kombinuje \texttt{QWebEngineView} (Leaflet mapa) a PyQt prvky.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth,height=0.62\textheight,keepaspectratio]{Figures/ukazka_aplikace.png}
